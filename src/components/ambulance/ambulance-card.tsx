      ...
      <CardContent className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2 text-sm">
          ...
          <div>
            ...
            <p>{ambulance.currentPatients} / {ambulance.capacity} Patients</p>
          </div>
        </div>
        <div>
          <p className="font-medium text-muted-foreground text-sm">Equipment</p>
