...
export const Icons = {
  ...
  MapPinned: (props: LucideProps) => <MapPinned {...props} />,
  ...
  Close: (props: LucideProps) => <XIcon {...props} />,
  ArrowRight: (props: LucideProps) => <ArrowRight {...props} />, // Added ArrowRight
};
