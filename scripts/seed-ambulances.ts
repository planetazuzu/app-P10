...
const sampleAmbulances: Omit<Ambulance, 'id'>[] = [
  {
    ...
    personnel: ["Conductor TES", "Ayudante TES"],
    latitude: 42.4612,
    longitude: -2.4495,
    currentPatients: 0,
  ...
  },
  {
    ...
    personnel: ["Conductor TES", "Enfermero/a DUE", "Médico/a"],
    latitude: 42.4650,
    longitude: -2.4500,
    currentPatients: 1,
  ...
  },
  {
    ...
    personnel: ["Conductor TES", "Técnico Sanitario"],
    currentPatients: 0,
  ...
  },
  {
    ...
    personnel: ["Conductor TES Avanzado", "Enfermero/a DUE", "Médico/a Intensivista"],
    latitude: 42.4600,
    longitude: -2.4480,
  },
];
